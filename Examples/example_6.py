...
if __name__=="__main__":
    ...
    slider_freq=blocks.gui_blocks.Gui_slider(min=250,max=350,name="Frequency",steps=1000)
    ...
    buff_1 = blocks.buffers.Buffer(sz=600)
    buff_2 = blocks.buffers.Buffer(sz=600)
    buff_3 = blocks.buffers.Buffer(sz=600)
