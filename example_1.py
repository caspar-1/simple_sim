...
if __name__ == "__main__":
    ...
    sine_1 = blocks.sources.sine_generator(freq=100, amplitude=1.0)
    sine_2 = blocks.sources.sine_generator(freq=110, amplitude=0.8)
    sine_3 = blocks.sources.sine_generator(freq=120, amplitude=0.6)
    sine_4 = blocks.sources.sine_generator(freq=130, amplitude=0.6)
    sine_5 = blocks.sources.sine_generator(freq=140, amplitude=0.8)
